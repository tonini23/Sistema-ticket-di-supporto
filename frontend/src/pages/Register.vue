  ...
  <div class="auth-wrapper d-flex flex-column justify-content-center align-items-center min-vh-100">
    ...
    <div class="auth-form-container w-100" style="max-width: 400px;">
      ...
      <div class="auth-field border rounded mb-3 d-flex align-items-center p-2">
        ...
        <input type="email" class="auth-input w-100 fw-bold" placeholder="EMAIL">
      </div>
      ...
      <div class="auth-field border rounded mb-3 d-flex align-items-center p-2">
        ...
        <input type="password" class="auth-input w-100 fw-bold" placeholder="PASSWORD">
      </div>
      ...
      <div class="auth-field border rounded mb-5 d-flex align-items-center p-2">
        ...
        <input type="password" class="auth-input w-100 fw-bold" placeholder="CONFERMA PASSWORD">
      </div>

      
      <button class="btn btn-light w-100 fw-bold py-2 rounded">
        REGISTRATI
      </button>
